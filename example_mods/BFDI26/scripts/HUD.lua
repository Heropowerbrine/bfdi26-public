...
makeLuaSprite('logomal','hud/logoMal',1195,640)
addLuaSprite('logomal',true)
setProperty('logomal.alpha',0)
setObjectCamera('logomal','other')

makeLuaSprite('logoch','hud/logoChalk',1195,640)
addLuaSprite('logoch',true)
setProperty('logoch.alpha',0)
setObjectCamera('logoch','other')

makeLuaSprite('logoal','hud/logoal',1195,640)
addLuaSprite('logoal',true)
setProperty('logoal.alpha',0)
setObjectCamera('logoal','other')
...
elseif songName == 'oneshot' or songName == 'oneshot-pico' then
    NAME = "oh, uh. hi?"
...
elseif songName == 'web-crasher' then
    ...
    elseif songName == 'himsheys' then
        fourbythree = true
         ...
         iconevil = false
        elseif songName == 'himsheys-tird' then
            fourbythree = true
             NAME = "January 2009 - Tax income return document's Candy Bar Adventure"
             iconevil = false
...
elseif songName == 'blue-golfball' then
            NAME =  "John BFDI 26"
    iconevil = false
elseif songName == 'blue-golfball-bf' then
    NAME =  "John BFDI 26 - now he's serious"
iconevil = false
...
font = 'flareserif-821-bt-bold.TTF'
setProperty('logojnj.alpha',0.5)
elseif songName == 'hard-bargain' then
NAME = "SELLING. CHILDREN."
setProperty('logojnj.alpha',0.5)
elseif songName == 'underway' then
    NAME = 'you certainly know a thing or two about punctuality!'
            font = 'BMSPA___.TTF'
            setProperty('logoal.alpha',0.5)
elseif songName == 'help-me' then
NAME = 'What?! Help me!'
setProperty('logoch.alpha',0.5)
elseif songName == 'hello-operator' then
NAME = 'Guess i could say, Hello!, Operator!'
setProperty('logomal.alpha',0.5)
elseif songName == 'bossy' then
NAME = 'I ain\'t taking orders from the likes of you!'
setProperty('logojnj.alpha',0.5)
end
...
function onUpdatePost()
    ...
    elseif (mouseClicked('left') or mouseClicked('right')) and getMouseY('other') >655 and getMouseY('other') <706 and getMouseX('other') >1215 and getMouseX('other') <1275 and getProperty('logomal.alpha') == 0.5 then
            runHaxeCode([[FlxG.openURL('https://www.youtube.com/@malues');]])
    elseif (mouseClicked('left') or mouseClicked('right')) and getMouseY('other') >655 and getMouseY('other') <706 and getMouseX('other') >1215 and getMouseX('other') <1275 and getProperty('logoal.alpha') == 0.5 then
            runHaxeCode([[FlxG.openURL('https://www.youtube.com/@Allenimations');]])
    elseif (mouseClicked('left') or mouseClicked('right')) and getMouseY('other') >655 and getMouseY('other') <706 and getMouseX('other') >1215 and getMouseX('other') <1275 and getProperty('logoch.alpha') == 0.5 then
